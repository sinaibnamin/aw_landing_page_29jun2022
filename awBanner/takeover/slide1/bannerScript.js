...
const pushAWAd = () =>{
    const unitLineItemName = `Valentino_VoceViva_Animated_Hero_wGutter`;
...
const cssWithoutServerPath = `:root{ --awThemeColor: #ebebeb;} #awGutterGlobalWrapper{ position: absolute; top: 0; left: 0; right: 0; width: 100%; height: 100%; overflow: hidden;} #awGutterTopBnrWrapperBack{ position: absolute; left: 0; right: 0; top: 139px; width: 100%; height: 250px; margin: 0 auto; margin-bottom: 16px; margin-top: 16px;} #awGutterTopBnrWrapperBack .awGutterTopBnrCreativeContentBack{ position: absolute; left: 0; right: 0; top: 0; width: 100%; height: 250px; max-width: 1008px; max-height: 250px; margin: 0 auto; background: var(--awThemeColor);} #awGutterWrapper{ z-index: 0; position: fixed; top: 0; width: 100%; height: 100vh; overflow: hidden; background-attachment: scroll; max-width: 2176px; max-height: 1484px; left: 0; right: 0; margin: auto; cursor: pointer;} #awGutterWrapper::before{ content: ''; position: fixed; top: 0; width: 100%; height: 100vh; overflow: hidden; background: url(responsive_hero_wGutter_largeSkin_bg.png) repeat 0; background-attachment: scroll; max-width: 2176px; max-height: 1484px; left: 0; right: 0; margin: auto; -webkit-animation: slideRightToLeft 47s linear infinite; animation: slideRightToLeft 47s linear infinite} #awGutterWrapper::after{ content: ''; position: fixed; top: 0; width: 100%; height: 100vh; overflow: hidden; background: url(responsive_hero_wGutter_largeSkin.png) no-repeat center bottom 0; background-attachment: scroll; max-width: 2176px; max-height: 1484px; left: 0; right: 0; margin: auto;} #awGutterGlobalWrapper #awSiteMiddleContentNavArea{ width: 1008px; margin: 0 auto; height: 61px; background: var(--awThemeColor); position: absolute; right: 0; left: 0; top: 0;} #awGutterGlobalWrapper #awSiteMiddleContentArea{ width: 1008px; margin: 0 auto; height: 100vh; background: var(--awThemeColor); position: absolute; right: 0; left: 0; top: 310px;} #awGutterWrapper .leftGutter{ position: absolute; top: 0; width: calc(50vw - 504px); height: 100%; right: 50%; -webkit-transform: translateX(-504px); -ms-transform: translateX(-504px); transform: translateX(-504px); max-width: 584px; max-height: 1484px;} #awGutterWrapper .rightGutter{ position: absolute; top: 0; width: calc(50vw - 504px); height: 100%; left: 50%; -webkit-transform: translateX(504px); -ms-transform: translateX(504px); transform: translateX(504px); max-width: 584px; max-height: 1484px;} #awGutterTopBnrWrapperFront{ position: relative; cursor: pointer;} #awGutterTopBnrWrapperFront .awGutterTopBnrCreativeContentFront{ position: sticky; left: 0; right: 0; width: 100%; height: 250px; margin: 0 auto; margin-bottom: 16px; margin-top: 16px; background: url(responsive_hero_wGutter_top_content.png) no-repeat center bottom 0;} @media screen and (max-width:1610px){ #awGutterWrapper::after{ background: url(responsive_hero_wGutter_midSkin.png) no-repeat center bottom 0}} @media screen and (max-width:1365px){ #awGutterWrapper::after{ background: url(responsive_hero_wGutter_smallSkin.png) no-repeat center bottom 0}} @media screen and (max-width:1279px){ #awGutterWrapper::after{ background: none}} @media screen and (max-width:959px){ #awGutterWrapper, #awGutterTopBnrWrapperFront{ display: none}} @-webkit-keyframes slideRightToLeft{ from{ background-position: 0 0} to{ background-position: -2176px 0}} @keyframes slideRightToLeft{ from{ background-position: 0 0} to{ background-position: -2176px 0}}`;
...
const formatAndInjectBanner = async () => {
    ...
    const adjustColorAsperAWSite = () => {
        let getColorFromAWSite = window.getComputedStyle(document.body, null).getPropertyValue('background-color');
        ...
        await (() => {
            ...
            window.addEventListener("scroll", (event) => {
                if (getYPosition() >= 1500) {
                    ...
                    awWebsiteNav?.querySelector('.tertiary-nav') ? (document.getElementById("awSiteMiddleContentArea").style.top = (marginTopForGutter + 150) + "px")
                        : (document.getElementById("awSiteMiddleContentArea").style.top = (marginTopForGutter + 310) + "px")
                }
            })
